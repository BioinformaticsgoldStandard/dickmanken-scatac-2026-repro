...
# (Dockerfile: git clone --branch v0.0.1 .../PUMATAC.git /home/jovyan/ATACflow).
# We verify the pre-installed copy instead of re-cloning.
PUMATAC_DIR="/home/jovyan/ATACflow"
...
nextflow -c atac_preprocess_rapid.config -c ../../config/nextflow_override.config run /home/jovyan/ATACflow/main_atac.nf -entry atac_preprocess_rapid
'''
...
# fixed absolute path (/home/jovyan/ATACflow) and is pinned to tag v0.0.1
